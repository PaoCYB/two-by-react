...
//imgsFigue的点击处理
  ...
  render() {
    ...
    var imgFigureCalssName="img-figure";
        imgFigureCalssName+= this.props.arrange.isInverse ? 'is-inverse':'';
    return (
      <figure className={imgFigureCalssName} style={styleObj}
